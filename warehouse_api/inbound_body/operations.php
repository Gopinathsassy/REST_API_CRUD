...
class testclass{
    ...
    // Table
    private $db_table = "wms_management_inbound_data";
    ...
    public function gettest(){
        $sqlQuery = "SELECT id, GRnum,matcode, matdesc , quantity, scan_date, scan_time, serial_num,uom FROM  .$this->db_table ORDER BY id DESC " ;
    ...
    // READ single
        ...
        $sqlQuery = "SELECT id, GRnum,matcode, matdesc , quantity, scan_date, scan_time, serial_num,uom  FROM ". $this->db_table ." WHERE id = ? LIMIT 0,1";
